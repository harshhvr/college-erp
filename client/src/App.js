...
import RegisterAdminOnce from "./Pages/RegisterAdminOnce";
...
import AdminFacultyStudentLoginPags from "./Pages/AdminFacultyStudentLoginPags";
...
function App() {
  return (
    <div>
      <Router>
        <Switch>
          <Route exact path="/" component={AdminFacultyStudentLoginPags} />
          <Route exact path="/registerAdmin" component={RegisterAdminOnce} />
